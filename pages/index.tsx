  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center">
      ...
      <main className="flex w-full h-full flex-col items-center justify-center text-center">
        <div className={`m-auto grid grid-cols-3 gap-4 flex flex-col items-center justify-center`}>
          {
          cache_?.map((obj) => {
            return (
              <div
                ...
                key={obj}
              >
                <img className={`w-full h-full object-cover rounded-lg`} src={obj?.image}/>
              </div>
            );
          })
          }
